...
import com.example.SmurfoUser.ChatBox.ChatWithUser;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage remoteMessage)
    {
        ...
        Intent intent = new Intent(this, ChatWithInstructor.class);
    ...
    private void sendNotification1(RemoteMessage remoteMessage)
    {
        ...
        RemoteMessage.Notification notification = remoteMessage.getNotification();
        int j = Integer.parseInt(user.replaceAll("[\\D]",""));
        Intent intent = new Intent(this, ChatWithUser.class);
        Bundle bundle = new Bundle();
        bundle.putString("userid",user);
        intent.putExtras(bundle);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
